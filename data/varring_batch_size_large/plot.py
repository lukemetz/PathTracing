...
pyplot.plot(work_groups, time_between_frames, 'o')
pyplot.ylabel("Time per frame (sec)")
pyplot.xlabel("Work group Size")
pyplot.title("Performance Based on Work Group Size for Large Images")
pyplot.legend(["NV 4200M", "Alecs computer here"])
pyplot.show()
